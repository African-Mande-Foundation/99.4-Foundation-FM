      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <h3 className="text-xl font-bold mb-4">Foundation FM News</h3>
            <p className="text-gray-300 mb-4 leading-relaxed">
              Your trusted source for local news, community updates, and stories that matter. 
              We bring you the latest developments from your neighborhood and beyond.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              ...
              <p>Email: news@foundationfm.com</p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-300 text-sm">
              © 2024 Foundation FM News. All rights reserved.
            </p>
