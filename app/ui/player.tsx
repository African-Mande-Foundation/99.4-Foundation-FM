...
const playlist = [
    { title: 'Song One', desc: 'Description of Music', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3' },
    { title: 'Song Two', desc: 'Description of Music', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3' },
    { title: 'Song Three', desc: 'Description of Music', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3' }
];
...
export default function Player() {
    ...
    // Stable version of playNextSong
    ...
    }, [playNextSong]); // ✅ now dependency-safe
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-5 absolute z-40 bottom-0 left-0 h-1/3 lg:h-20 w-screen bg-[#1b1b1b] lg:bg-[#1b1b1bcc]">
            ...
            <div className="flex flex-col w-full lg:w-1/2 px-2 items-center justify-end text-left">
                <div className="w-full">
                    <p className="text-white text-sm font-semibold mb-1">Amplifying voices, education, community engagement</p>
                    <p className="text-[#03FFDD] text-sm font-semibold mb-1">Your voice, your station</p>
                </div>
            </div>
            ...
            <div className="flex items-center gap-6 text-white">
                ...
                <button
                    ...
                    className="bg-transparent border-2 border-white px-4 py-2 rounded hover:border-[#03FFDD] text-white hover:text-[#03FFDD] font-semibold transition duration-200 cursor-pointer"
                >
