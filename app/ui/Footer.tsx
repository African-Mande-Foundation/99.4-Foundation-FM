            ...
            <div className="flex flex-col md:flex-row items-start justify-center w-full ">
                <div className="flex flex-col lg:flex-row items-start justify-center w-full md:w-1/2 border-amber-400 border-0">
                    <div className="flex flex-col gap-4 w-full lg:w-1/2 mb-16">
                        ...
                        <Link href=""><p className="text-sm">Africano Mande Foundation</p></Link>
                        <Link href="">
                ...
                <div className="flex flex-col lg:flex-row items-start justify-around w-full md:w-1/2 border-amber-400 border-0  ">
                    ...
                    <div className="flex flex-col gap-4 w-full lg:w-1/2 mb-16">
                        ...
                        <div className="flex items-center justify-start gap-2"><FontAwesomeIcon icon={faPhone}/> <p className="text-sm">+211 929 756 681</p></div>
                        <div className="flex items-center justify-start gap-2"><FontAwesomeIcon icon={faWhatsapp}/> <p className="text-sm">+211 919 599 084</p></div>
                        <div className="flex items-center justify-start gap-2"><FontAwesomeIcon icon={faEnvelope}/> <p className="text-sm">info@africanomandefoundation.org</p></div>
                    </div>
                </div>
