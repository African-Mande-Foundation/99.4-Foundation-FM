...
const samplePodcasts = [
  {
    ...
    youtubeUrl:
      "https://www.youtube.com/watch?v=hZ2Zi7nfCd0&pp=ygUIcG9kY2FzdHM%3D",
  },
  {
    id: 2,
    title: "Single Dee",
    ...
    youtubeUrl:
      "https://www.youtube.com/watch?v=iB4SsbmuTDc&pp=ygUIcG9kY2FzdHPSBwkJxwkBhyohjO8%3D",
  },
  {
    id: 3,
    title: "vee",
    ...
    youtubeUrl:
      "https://www.youtube.com/watch?v=uGPwswAvV2s&pp=ygUIcG9kY2FzdHM%3D",
  },
];
...
export default function Podcasts() {
  ...
  return (
    <div className="bg-[#0d0d0d] text-white py-12 px-4">
      ...
      <div className="relative max-w-6xl border-0 min-h-[20rem]">
        <Swiper
          ref={swiperRef}
